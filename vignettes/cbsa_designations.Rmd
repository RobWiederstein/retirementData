...
When these were merged with the `retirementLoc` dataset, a number of "NA"s were generated.  The missing values were assigned the charachter string `rural-faraway`.  The different areas often have different characteristics and outcomes.  For that reason, this vignette was written to draw readers' attention to this important and useful variable.
